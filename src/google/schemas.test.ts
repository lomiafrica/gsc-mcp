...
import { homepageFromSiteUrl, assertInspectionUrlUnderSite, inclusiveDateRange } from '../google/schemas.js';
import {
...
describe('portfolio helpers', () => {
  ...
  it('prefers explicit sites, then env, then every accessible property', () => {
    ...
    process.env.GSC_PORTFOLIO_SITES = 'sc-domain:lomi.africa, sc-domain:beecargo.net';
    expect(
      resolvePortfolioSites(['sc-domain:userill.com'], ['sc-domain:lomi.africa']),
